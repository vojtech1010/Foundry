...
describe('legal transition route contract', () => {
  it('enumerates every documented route and target', () => {
    const routes: ReadonlyArray<readonly [WorkflowTransitionRouteKind, string, string]> = [
      ...
      ['review-requested-implementation', 'reviewing', 'coding'],
  ...
  it.effect('refuses illegal jumps and missing facts without changing the record', () =>
    Effect.gen(function* () {
      ...
      > = [
        ...
        [
          'no-change completion without passed checks',
          'reviewing',
          {
            route: 'review-approved-no-change',
            verifiedSourceApproved: true,
        ...
        [
          'no-change completion without source-bound evidence',
          'reviewing',
          {
            route: 'review-approved-no-change',
            verifiedSourceApproved: true,
        ...
        [
          'implementation request without a verified no-change candidate',
          'reviewing',
          {
            route: 'review-requested-implementation',
            verifiedNoChangeCandidate: false,
          },
          'no-change candidate',
        ],
        [
