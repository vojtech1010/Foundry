...
| [0011](0011-free-form-handoffs-and-minimal-protocols.md) | Free-form handoffs and minimal protocol contracts                          | Accepted |
| [0012](0012-authenticated-github-decisions.md)           | Authenticated GitHub decision commands                                     | Accepted |

## Conventions

- One decision per file: context, decision, consequences, rejected
  alternatives, enforcement/verification.
- Status is `Accepted` for the records above. Later changes add a new
