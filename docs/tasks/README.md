...
| [056](056-in-process-role-host-adapter.md)      | Role-host adapter operations move into the Foundry process                |
| [057](057-herdr-role-sessions.md)               | Role sessions run as recognized agents in owned Herdr panes               |
| [058](058-no-human-decision.md)                 | Reviewer never routes to a human decision; caveats travel with the result |
